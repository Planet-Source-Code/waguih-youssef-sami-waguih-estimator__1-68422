VERSION 5.00
Begin VB.Form frmEquipCat 
   Caption         =   "Categorize Equipment"
   ClientHeight    =   3990
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   6540
   ...
   Begin VB.ListBox List1 
      Height          =   2595
      ItemData        =   "frmEquipCat.frx":0000
      Left            =   240
      List            =   "frmEquipCat.frx":0002
      TabIndex        =   6
      Top             =   960
      Width           =   4335
   End
...
Exit Sub
End If
Open Equipment For Append As #1
Print #1, KK
Close #1
