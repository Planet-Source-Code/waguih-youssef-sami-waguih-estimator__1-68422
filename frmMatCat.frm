VERSION 5.00
Begin VB.Form frmMatCat 
   Caption         =   "Categorize Material"
   ClientHeight    =   3990
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   6540
   ...
   Begin VB.ListBox List1 
      Height          =   2595
      ItemData        =   "frmMatCat.frx":0000
      Left            =   240
      List            =   "frmMatCat.frx":0002
      TabIndex        =   1
      Top             =   1080
      Width           =   4335
   End
...
Exit Sub
End If
Open Materials For Append As #1
Print #1, KK
Close #1
List1.Clear
FillList
